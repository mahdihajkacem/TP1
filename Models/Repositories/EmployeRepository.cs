...
new Employee {Id=2,Name="Kamel twati", Departement= "RH",Salary=2500},
new Employee {Id=3,Name="Sami tounsi", Departement= "informatique",Salary=2700},
new Employee {Id=4,Name="salah zweri", Departement= "Comptabilité",Salary=2100}
};
        }
